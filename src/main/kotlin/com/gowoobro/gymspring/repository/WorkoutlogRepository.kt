...
interface WorkoutlogRepository : JpaRepository<Workoutlog, Long> {
    @EntityGraph(attributePaths = [
        ...
        "attendance.usehealth.health",
        "attendance.usehealth.term",
        "attendance.usehealth.discount",
        "attendance.usehealth.gym",
        "attendance.usehealth.membership",
        "attendance.usehealth.user",
        "attendance.usehealth.order",
        "attendance.gym",
        "health",
